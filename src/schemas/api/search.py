...
class SearchRequest(BaseModel):
    query: str = Field(..., min_length=1, max_length=500, description="Search query across titles, abstract")
    ...
    categories: Optional[List[str]] = Field(default=None, description="Filter by ctagories")
    latest_papers: bool = Field(default=False, description="Sort by publication date")
